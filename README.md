...
캠프 모닥불 주변에는 계정이 실제로 획득한 전투 용병만 메인 진영에 생활합니다. 지원·파견 전담 용병은 별도 시설 위치에 전용 픽셀 모습으로 나타나며, 파견 중인 용병은 귀환할 때까지 캠프에서 빠집니다. 작전실에서는 지원 전술 Lv.1–5 강화와 5/15/30/60분 후방 파견을 관리합니다.
