...
class AccountSave {
  ...
  factory AccountSave.betaTest() => AccountSave.initial().copyWith(
    ...
    equippedGearByMercenary: const {
      ...
      'nyra:armor': 'moonweave_guard',
      'nyra:accessory': 'windrunner_ring',
      'nyra:tactical': 'moonstep_hook',
      'aurel:armor': 'veteran_plate',
      'aurel:accessory': 'commander_medal',
      'aurel:tactical': 'smoke_charge',
      'vesta:armor': 'moonweave_guard',
      'vesta:accessory': 'nightfang_charm',
      'vesta:tactical': 'officer_map_case',
      'rask:armor': 'black_iron_coat',
      'rask:accessory': 'commander_medal',
      'rask:tactical': 'smoke_charge',
      'iris:armor': 'moonweave_guard',
    ...
    mercenaryProgress: const {
      ...
      'nyra': MercenaryProgress(level: 38, xp: 0, ascension: 0),
      'aurel': MercenaryProgress(level: 41, xp: 0, ascension: 0),
      'vesta': MercenaryProgress(level: 39, xp: 0, ascension: 0),
      'rask': MercenaryProgress(level: 43, xp: 0, ascension: 0),
